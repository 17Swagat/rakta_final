...
import 'package:rakta_blood_donation/donate/donorsListByBloodGrp/apostiveList.dart';
...
class A_positiveMain extends StatefulWidget {
  ...
  @override
  State<A_positiveMain> createState() => _A_positiveMainState();
}

class _A_positiveMainState extends State<A_positiveMain> {
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                width: MediaQuery.of(context).size.width - 100,
                child: ElevatedButton(onPressed: (){
                  Navigator.pushNamed(context, "/ap_list_map_donors");
                },
                style: ElevatedButton.styleFrom(
                  // backgroundColor: Colors.redAccent
                  primary: Colors.redAccent,
  ...
  //           items: [
  //             BottomNavigationBarItem(
  //                 icon: Icon(Icons.bloodtype_outlined), label: 'Donor List'),
  //             BottomNavigationBarItem(
