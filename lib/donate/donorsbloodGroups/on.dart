...
class O_NegativeList extends StatefulWidget {
  const O_NegativeList({ Key? key }) : super(key: key);

  @override
  State<O_NegativeList> createState() => _O_NegativeListState();
}

class _O_NegativeListState extends State<O_NegativeList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("O- Donors List"),
      ...
      body: Container(
        ...
        child: StreamBuilder(
          ...
          .where('Blood Group', whereIn: ['o-', 'O-']).snapshots(),
          // .where('Blood Group', isEqualTo: 'o-').snapshots(),
