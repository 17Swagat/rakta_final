...
class A_NegativeList extends StatefulWidget {
  const A_NegativeList({ Key? key }) : super(key: key);

  @override
  State<A_NegativeList> createState() => _A_NegativeListState();
}

class _A_NegativeListState extends State<A_NegativeList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("A- Donors List"),
