...
class B_NegativeList extends StatefulWidget {
  const B_NegativeList({ Key? key }) : super(key: key);

  @override
  State<B_NegativeList> createState() => _B_NegativeListState();
}

class _B_NegativeListState extends State<B_NegativeList> {
  @override
