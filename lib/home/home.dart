        ...
        child: InkWell(
          onTap: () {
            ...
            if (index == 5) {
              ...
              // code to exit from the app (Only for @Android)
  ...
  show_bloodRequestConfimationDialog_2(context) {
    ...
    Widget continueButton = TextButton(
      ...
      await FirebaseFirestore.instance
          ...
          await FirebaseFirestore.instance.collection('Donors').doc('${FirebaseAuth.instance.currentUser!.email}').set({
            'Name': name,
            ...
            Expanded(
              ...
              children: [
                ...
                makeDashBoardItems(
                    ...
                    "Request Blood", "assets/images/blood_donateLogo128.png", 2),
                //index 3
                makeDashBoardItems(
                "Donate Blood",
                ...
                makeDashBoardItems(
                    "Available Donors", 
                    "assets/thirdParty/todo.png", 4), //NOTE: @have to change ->> 'On clicking this button the the user will be set on the 'Donors' collection.!! HAVE TO CHANGE'
                //index 5
                makeDashBoardItems(
                "Logout", 
                "assets/images/logoutLogo128.png", 
                5),
              ],
            ))
          ],
